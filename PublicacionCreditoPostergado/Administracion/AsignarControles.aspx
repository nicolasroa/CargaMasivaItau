<%@ Page Title="" Language="C#" MasterPageFile="~/Master/PoPup.Master" AutoEventWireup="true"
    CodeBehind="AsignarControles.aspx.cs" Inherits="Documental.Administracion.AsignarControles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenedorMasterPopup" runat="server">
    <table style="width: 100%;">
            ...
            <td class="tdFormulario01">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            <anthem:DropDownList AutoUpdateAfterCallBack="true" ID="ddlRol" runat="server" AutoCallBack="True"
        ...
        <tr>
            <td class="tdFormulario01">
                <anthem:GridView ID="gvConfiguracionControles" runat="server" AutoGenerateColumns="False"
                    CssClass="Grid" AutoUpdateAfterCallBack="true" PageSize="18" UpdateAfterCallBack="True"
        ...
        <tr>
            <td align="center">
                <anthem:Button  PreCallBackFunction="this.disabled = true" PostCallBackFunction="this.disabled = false" EnabledDuringCallBack="False"  ID="btnProcesar" runat="server" CssClass="myButton" OnClick="btnProcesar_Click"
                ...
                &nbsp;
                <anthem:Button  PreCallBackFunction="this.disabled = true" PostCallBackFunction="this.disabled = false" EnabledDuringCallBack="False"  ID="btnCerrar" runat="server" CssClass="myButton" OnClick="btnCerrar_Click"
                    Text="Cerrar" />
            </td>
        </tr>
    </table>
