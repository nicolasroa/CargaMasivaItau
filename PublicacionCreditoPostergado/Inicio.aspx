        ...
        <tr>
            ...
            <td class="tdLogo" valign="top">
                <table class="EncabezadoTitulo" style="width: 100%;">
                    <tr>
                        <td align="left" rowspan="4" style="padding-left: 30px; font-size: medium;" 
                            width="350">
            ...
            <td>
                ...
                <div id="TabPrincipal" style="background-color: #FFFFFF; border-style: groove">
                    <ul>
                        ...
                        <li><a id="tabBitacora" runat="server" href="#tabs3">Historial</a></li>
                    </ul>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="tdFormulario02">
                                                <asp:Image ID="imgVigenteSolicitud" runat="server" ImageUrl="~/Img/IconGreen.png" />
                                                &nbsp;Vigente
                                                <asp:Image ID="imgPorVencerSolicitud" runat="server" ImageUrl="~/Img/IconYellow.png" />
                                                &nbsp;Por Vencer
                                                <asp:Image ID="imgVencidoSolicitud" runat="server" ImageUrl="~/Img/IconRed.png" />
                                                &nbsp;Vencido
                                            </td>
                                        </tr>
                                    </table>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" style="text-align: center">
                                                                <anthem:Button ID="btnGuardar" runat="server" OnClick="btnGuardar_Click" Text="Guardar"
                                                                    Visible="false" TextDuringCallBack="Guardando..." CssClass="ui-button ui-widget ui-corner-all" AutoUpdateAfterCallBack="true" />
                                                                <anthem:Button ID="btnCancelar" runat="server" Text="Cancelar" TextDuringCallBack="Cancelando..."
                                                                    CssClass="ui-button ui-widget ui-corner-all" OnClientClick="MostrarFormularioPortal();" OnClick="btnCancelar_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                            ...
                            <tr>
                                <td width="25%" valign="top">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="tdFormulario02">
                                                <asp:Image ID="imgVigentePersona" runat="server" ImageUrl="~/Img/IconGreen.png" />
                                                &nbsp;Vigente
                                                <asp:Image ID="imgPorVencerPersona" runat="server" ImageUrl="~/Img/IconYellow.png" />
                                                &nbsp;Por Vencer
                                                <asp:Image ID="imgVencidoPersona" runat="server" ImageUrl="~/Img/IconRed.png" />
                                                &nbsp;Vencido
                                            </td>
                                        </tr>
                                    </table>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" style="text-align: center">
                                                                <anthem:Button ID="btnGuardarRep" runat="server" Text="Guardar" Visible="false" TextDuringCallBack="Guardando..."
                                                                    CssClass="ui-button ui-widget ui-corner-all" AutoUpdateAfterCallBack="true" OnClick="btnGuardarRep_Click" />
                                                                &nbsp;<anthem:Button ID="btnCancelarRep" runat="server" Text="Cancelar" TextDuringCallBack="Cancelando..."
                                                                    CssClass="ui-button ui-widget ui-corner-all" OnClick="btnCancelarRep_Click" OnClientClick="MostrarFormularioPortalRep();" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                            ...
                            <tr>
                                <td valign="top" height="450px">
                                    <anthem:GridView ID="gvwBitacora" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvwBitacora_RowDataBound"
                                        ...
                                        AllowPaging="True" onpageindexchanging="gvwBitacora_PageIndexChanging" 
                                        PageSize="15">
                                        <RowStyle CssClass="GridItem" />
                                        <PagerStyle CssClass="GridPager" HorizontalAlign="Center" />
                                        <HeaderStyle CssClass="GridHeader" />
