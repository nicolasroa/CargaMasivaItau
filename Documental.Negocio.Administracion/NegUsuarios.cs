    ...
    public class NegUsuarios
    {
        ...
        public Resultado<UsuarioInfo> Guardar(UsuarioInfo Entidad)
        {
            ...
            try
            {
                ...
                ObjetoResultado = AccesoDatos.Operacion<UsuarioInfo>(Entidad, Documental.Data.Global.SP.Usuario_INS, Documental.Data.Global.Accion.Guardar);
        ...
        public Resultado<UsuarioInfo> Guardar(ref UsuarioInfo Entidad)
        {
            ...
            try
            {
                ...
                ObjetoResultado = AccesoDatos.Operacion<UsuarioInfo>(ref Entidad, Documental.Data.Global.SP.Usuario_INS, Documental.Data.Global.Accion.Guardar);
        ...
        public Resultado<UsuarioInfo> Buscar(UsuarioInfo Entidad)
        {
            ...
            try
            {
                ObjetoResultado = AccesoDatos.Buscar<UsuarioInfo, UsuarioInfo>(Entidad, Documental.Data.Global.SP.Usuario_QRY);
        ...
        public Resultado<UsuarioRolInfo> AsignarUsuarioRol(UsuarioRolInfo Entidad)
        {
            ...
            {
                Entidad.UsuarioModificacion_Id = (int)Administracion.NegUsuarios.UsuarioId;
                ObjetoResultado = AccesoDatos.Operacion<UsuarioRolInfo>(Entidad, Documental.Data.Global.SP.UsuarioRol_INS, Documental.Data.Global.Accion.Guardar);
        ...
        public Resultado<UsuarioInfo> Validar(UsuarioInfo Entidad)
        {
            ...
            try
            {
                ...
                if (ObjetoResultado.ResultadoGeneral)
                {
                    ...
                    //Clave Incorrecta
                    else if (ObjetoUsuario.Clave != Seguridad.Encriptar(Entidad.Clave)) { ObjetoResultado.ValorString = ConfigUsuario.ValidacionErrorClave; ObjetoResultado.Objeto = ObjetoUsuario; }
                    // Cambio de Clave
