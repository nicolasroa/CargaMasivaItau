        ...
        <div id="divLogin">
            <anthem:Panel ID="pnlLogin" runat="server" AutoUpdateAfterCallBack="true">
                <table class="tdFormulario01" style="width: 100%;">
                    ...
                    <tr>
                        <td align="center">
                            <anthem:Button ID="btnValidar" runat="server" AutoUpdateAfterCallBack="true" CssClass="ui-button ui-widget ui-corner-all" Text="Validar" OnClick="btnValidar_Click" />
                            &nbsp;<anthem:Button ID="btnCancelarLogin" runat="server" AutoUpdateAfterCallBack="true" CssClass="ui-button ui-widget ui-corner-all" OnClick="btnValidar_Click" Text="Cancelar" />
                            <br />
