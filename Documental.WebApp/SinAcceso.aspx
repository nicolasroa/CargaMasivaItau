<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SinAcceso.aspx.cs" Inherits="Documental.WebApp.SinAcceso" %>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                &nbsp;</td>
                            <td class="tdTitulo01" align="center" style="text-align: center; font-size: 20px;">
                                <anthem:Label ID="lblError" runat="server" AutoUpdateAfterCallBack="True" 
