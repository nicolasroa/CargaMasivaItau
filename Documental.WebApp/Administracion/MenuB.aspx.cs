...
namespace WebSite.Administracion
{
    public partial class MenuB : System.Web.UI.Page
    {
        ...
        protected void btnVerControles_Click(object sender, ImageClickEventArgs e)
        {
            GridViewRow row = ((ImageButton)sender).Parent.Parent as GridViewRow;
            int Id = int.Parse(gvBusqueda.DataKeys[row.RowIndex].Values[Constantes.StringId].ToString());
            VerControles(Id);
        ...
        protected void btnAsignarControles_Click(object sender, ImageClickEventArgs e)
        {
             GridViewRow row = ((ImageButton)sender).Parent.Parent as GridViewRow;
            int Id = int.Parse(gvBusqueda.DataKeys[row.RowIndex].Values[Constantes.StringId].ToString());
        ...
        private bool ValidarFormulario()
        {
            ...
            {
                Controles.MensajeEnControl(txtFormDescripcion.ClientID, ArchivoRecursos.ObtenerValorNodo(Constantes.MensajesUsuario.ValidarDescripcion.ToString()));
                return false;
            }
            ...
            {
                Controles.MensajeEnControl(rblFormTipo.ClientID, ArchivoRecursos.ObtenerValorNodo(Constantes.MensajesUsuario.ValidarTipoMenu.ToString()));
                return false;
            }
            return true;
        }
        ...
        private void LlenarFormulario(MenuInfo ObjetoMenu)
        {
            try
            {
                ...
                CargarMenuPadreForm(byte.Parse(ddlFormNivel.SelectedValue));
                if (ObjetoMenu.MenuPadre_Id != null) { ddlFormMenuPadre.SelectedValue = ObjetoMenu.MenuPadre_Id.ToString(); }
