                    ...
                    <div id="tabs1">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td class="tdFormulario01" align="center" style="text-align: center;">
                                    <anthem:Button ID="btnProcesar" runat="server" CssClass="ui-button ui-widget ui-corner-all"
                                        Text="Procesar Registros Validados" OnClick="btnProcesar_Click" OnMouseDown="javascript:MensajeConfirmacion('Solo se crearás las solicitudes de los registros validados ¿Seguro que desea continuar?',this);" />
                            ...
                            <tr class="tdFormulario01">
                                <td>
                                    <anthem:GridView ID="gvNomina" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodigoSucursal" HeaderText="Código de la Sucursal" />
                                ...
                                <td>
                                    <anthem:GridView ID="gvSolicitudesCreadas" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MontoAprobado" HeaderText="Monto Aprobado" DataFormatString="{0:F4}" />
                                            <asp:BoundField DataField="Canal" HeaderText="Canal de Venta" />
                                            <asp:BoundField DataField="CodigoSucursal" HeaderText="Nro Sucursal de Gestión" />
