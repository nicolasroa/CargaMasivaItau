...
namespace Documental
{
    public partial class Inicio2 : System.Web.UI.Page
    {
        ...
        private void ObtenerDatosWorkflow()
        {
            try
            {
        ...
        private void CargarGrillaDocumentoSolicitud()
        {
            try
            {
                ...
                if (ObjetoResultado.ResultadoGeneral)
                {
                    ...
                    Controles.CargarGrid<EntityDOC.ArchivosRepositoriosInfo>(ref gvwDocumentosSolicitud, ObjetoResultado.Lista, new string[] { Constantes.StringId });
                }
                else
                {
        ...
        private void CargarGrillaRepositorioDocumento()
        {
            try
            {
                ...
                //Asignación de Variables de Búsqueda
                ObjetoArchRep.IdGrupoDocumento = int.Parse(ddlGrupoDocumentoRep.SelectedValue);
                ObjetoArchRep.IdTipoDocumento = int.Parse(ddlTipoDocumentoRep.SelectedValue);
                ObjetoArchRep.Rut = NegPortal.getsetDatosWorkflow.Rut;
                //ObjetoArchRep.IdRolWF = NegPortal.getsetDatosWorkflow.i;
                ...
                if (ObjetoResultado.ResultadoGeneral)
                {
                    ...
                    Controles.CargarGrid<EntityDOC.ArchivosRepositoriosInfo>(ref gvwRepositorioDocumento, ObjetoResultado.Lista, new string[] { Constantes.StringId });
                }
                else
                {
                    Controles.MostrarMensajeError(ObjetoResultado.Mensaje);
        ...
        private void CargarBandejaGrupoDocumentoRepositorio()
        {
            try
            {
                ...
                //Asignación de Variables de Búsqueda
                ObjetoArchivoRep.Rut = NegPortal.getsetDatosWorkflow.Rut;
        ...
        private void GuardarEntidadRep()
        {
            try
            {
                ...
                ObjetoArchivoRep.Descripcion = txtObservacionRep1.Text;
        ...
        private void EliminarArchivoRepositorio(int Id)
        {
            try
            {
                //Declaración de Variables
        ...
        private void AsignarDocumentoSolicitud(int Id)
        {
            try
            {
                //Declaración de Variables
        ...
        private void LlenarFormularioRep(EntityDOC.ArchivosRepositoriosInfo oArchivoRepositorio)
        {
            try
            {
                ...
                txtObservacionRep1.Text = oArchivoRepositorio.Descripcion;
            }
            catch (Exception Ex)
            {
                if (Constantes.ModoDebug == true)
        ...
        private void ExportarAExcel()
        {
            ...
            Resultado = Excel.ExportarGrid<BitacoraInfo>(gvwBitacora, NegBitacora.getLstBitacora, "Bitacora", "Reporte de Bitacora");
